...
author: Kaitlyn Johnson
  afiliation: London School of Hygiene and Tropical Medicine
...
The `baselinenowcast` package provides modular functions that make implementation straightforward for practitioners. Find out more in the pre-print [link] and explore the [package](https://baselinenowcast.epinowcast.org/index.html).
...
- A number of nowcasting methods have been developed to handle this exact phenomena (Meyer et al. 2017; Sam Abbott et al. ; McGough et al. 2020; Lopes and Bastos 2025; Gressani et al. 2022), and some have been successfully operationalized, such as in Germany at RKI for COVID-19 and acute respiratory virus incidence (RESPINOW-Hub ; Scholler et al. 2025), at UKHSA for flu, norovirus, and RSV (Mellor et al. 2025), at the U.S. CDC for visual display of trends in ILI (Respiratory Virus Hospitalization Sur...), and in Massachusetts for COVID-19 admissions (Massachusetts syndromic surveillance ...). 

- However, these are still the exception, as is exemplified by the U.S. CDC’s measles dashboard, with routine nowcast correction still lacking widespread public health adoption. 
- We identified two critical gaps in this space: 

1. There isn’t an empirically-driven, relatively straightforward tool catered to the epidemiological context that can fill the (Wolffram et al. 2023) needs of public health practitioners. 
...
- To address these two gaps, we developed an R package, called baselinenowcast which implements an empirically-driven chain ladder method, based on the approach used by Wolffram et al. (Wolffram et al. 2023) as a reference model in the German COVID Nowcast Hub (Lab et al. ) challenge in 2021 and 2022. 
